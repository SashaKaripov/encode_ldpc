...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "origin/master"
  WORKING_DIRECTORY "D:/encode_ldpc/build/_deps/doctest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/encode_ldpc/build/_deps/doctest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/encode_ldpc/build/_deps/doctest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
